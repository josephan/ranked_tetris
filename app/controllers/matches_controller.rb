...
class MatchesController < ApplicationController
  ...
  def index
    @confirmed_matches = Match.includes(:winner, :player_one, :player_two).confirmed.page(params[:page]).latest
  ...
  def create
    ...
    if @match.save
      GhettoSlack.send_to_user(player_two, @match.message)
  ...
  def confirm
    ...
    if correct_confirmation_code && correct_user
      ...
      GhettoSlack.send_message(@match.message)
